...
3. `04c-conformance-and-binding-rollout.md`: `nnrp-conformance` adapter integration and downstream binding-consumption contract.
...
3. `04c` depends on `04a/04b` artifacts and owns adapter integration, fixture-backed validation, and binding-consumption notes.
