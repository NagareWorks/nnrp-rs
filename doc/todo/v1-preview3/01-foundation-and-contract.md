...
- [ ] Finalize crate ownership boundaries as the frozen preview3 contract turns into code.
...
- [ ] Land the frozen priority, operation-state, cancel-scope, and `FLOW_UPDATE` metadata/enum contract in `nnrp-core`.
