...
```powershell
cargo add nnrp-core@1.0.0-preview.4.2 nnrp-runtime@1.0.0-preview.4.2 nnrp-transport-tcp@1.0.0-preview.4.2
...
```powershell
cargo add nnrp-transport-quic@1.0.0-preview.4.2
cargo add nnrp-transport-ipc@1.0.0-preview.4.2
cargo add nnrp-transport-websocket@1.0.0-preview.4.2
cargo add nnrp-transport-provider@1.0.0-preview.4.2
cargo add nnrp-ffi@1.0.0-preview.4.2
cargo add nnrp-wasm@1.0.0-preview.4.2
```
...
```toml
[dependencies]
nnrp-core = "1.0.0-preview.4.2"
nnrp-runtime = "1.0.0-preview.4.2"
nnrp-transport-tcp = "1.0.0-preview.4.2"

# Optional packages
nnrp-transport-provider = "1.0.0-preview.4.2"
nnrp-transport-quic = "1.0.0-preview.4.2"
nnrp-transport-ipc = "1.0.0-preview.4.2"
nnrp-transport-websocket = "1.0.0-preview.4.2"
nnrp-ffi = "1.0.0-preview.4.2"
nnrp-wasm = "1.0.0-preview.4.2"
```
