...
```powershell
cargo add nnrp-core@1.0.0-preview.4.13 nnrp-runtime@1.0.0-preview.4.13 nnrp-transport-tcp@1.0.0-preview.4.13
...
```powershell
cargo add nnrp-transport-quic@1.0.0-preview.4.13
cargo add nnrp-transport-ipc@1.0.0-preview.4.13
cargo add nnrp-transport-websocket@1.0.0-preview.4.13
cargo add nnrp-transport-provider@1.0.0-preview.4.13
cargo add nnrp-ffi@1.0.0-preview.4.13
cargo add nnrp-wasm@1.0.0-preview.4.13
```
...
```toml
[dependencies]
nnrp-core = "1.0.0-preview.4.13"
nnrp-runtime = "1.0.0-preview.4.13"
nnrp-transport-tcp = "1.0.0-preview.4.13"

# Optional packages
nnrp-transport-provider = "1.0.0-preview.4.13"
nnrp-transport-quic = "1.0.0-preview.4.13"
nnrp-transport-ipc = "1.0.0-preview.4.13"
nnrp-transport-websocket = "1.0.0-preview.4.13"
nnrp-ffi = "1.0.0-preview.4.13"
nnrp-wasm = "1.0.0-preview.4.13"
```
