    ...
    fn wasm_runtime_control_metadata_json_round_trips_preview4_profiles() {
        let cases = [
            ...
            (
                ...
                r#"{"profile_id":35,"capability_count":1,"cost_model_id":37,"preference_rank":38,"limit_bytes":"39","limit_units":"40","body_bytes":26,"flags":0}"#,
                &b"\x18\0control.capability_costs"[..],
                "profile_id",
                serde_json::json!(35),
            ),
            (
                MessageType::DegradeProfile,
                r#"{"profile_id":41,"capability_count":1,"cost_model_id":43,"preference_rank":44,"limit_bytes":"45","limit_units":"46","body_bytes":25,"flags":0}"#,
                &b"\x17\0control.degrade_profile"[..],
                "profile_id",
                serde_json::json!(41),
            ),
            (
